...
TERM_PLANS = [
    (
        ...
        [
            ...
            dict(s_no=4, type="CR", nature="DSC", course="CSE111"),
            dict(s_no=5, type="CR", nature="DSC", course="CSE326"),
            dict(s_no=6, type="CR", nature="DSC", course="INT108"),
            dict(s_no=7, type="CR", nature="BSC", course="MTH174"),
            dict(s_no=8, type="CR", nature="LCS", course="PES318"),
        ],
    ),
    (
        2,
        ...
        [
            ...
            dict(s_no=5, type="CR", nature="DSC", course="CSE101"),
            dict(s_no=6, type="CR", nature="DSC", course="CSE121"),
            dict(s_no=7, type="CR", nature="DSC", course="CSE320"),
            dict(s_no=8, type="CR", nature="DSC", course="INT306"),
            dict(s_no=9, type="CR", nature="BSC", course="MTH401"),
        ],
    ),
    (
        3,
        ...
        [
            ...
            dict(s_no=4, type="CR", nature="DSC", course="CSE202"),
            dict(s_no=5, type="CR1", nature="DSC", course="CSE205"),
            dict(s_no=6, type="CR1", nature="DSC", course="CSE306"),
            dict(s_no=7, type="CR1", nature="DSC", course="CSE307"),
            dict(s_no=8, type="CR3", nature="PRC", course="GEN231"),
        ],
    ),
    (
        4,
        ...
        [
            ...
            dict(s_no=6, type="CR", nature="DSC", course="CSE211"),
            dict(s_no=7, type="CR", nature="DSC", course="CSE310"),
            dict(s_no=8, type="CR", nature="DSC", course="INT428"),
        ],
    ),
    (
        5,
        ...
        [
            ...
            dict(s_no=7, type="CR", nature="DSC", course="CSE408"),
        ],
    ),
    (
        6,
        ...
        [
            ...
            dict(s_no=5, type="CR", nature="DSC", course="CSE322"),
            dict(s_no=6, type="CR", nature="DSC", course="CSE332"),
            dict(s_no=7, type="CR", nature="DSC", course="CSE393"),
        ],
    ),
    (
        7,
        ...
        [
            ...
            dict(s_no=6, type="CR", nature="PRJ", course="CSE339"),
        ],
    ),
    (
        7,
        ...
        "Term 7 (industrial internship)",
        [
            dict(s_no=1, type="CR", nature="TCF", course="CSE447"),
        ],
    ),
    (
        8,
        ...
        [
            ...
            dict(s_no=4, type="CR", nature="SMN", course="CSE435"),
            dict(s_no=5, type="CR", nature="PRJ", course="CSE439"),
        ],
    ),
    (
        8,
